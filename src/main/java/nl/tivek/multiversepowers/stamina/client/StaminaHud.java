...
public final class StaminaHud {
    private static final ResourceLocation LAYER_ID =
            ResourceLocation.fromNamespaceAndPath(MultiversePowers.MODID, "stamina_bar");

    private static final ResourceLocation SPRITE_FULL =
            ResourceLocation.fromNamespaceAndPath(MultiversePowers.MODID, "hud/stamina/full");
    private static final ResourceLocation SPRITE_HALF =
            ResourceLocation.fromNamespaceAndPath(MultiversePowers.MODID, "hud/stamina/half");
    private static final ResourceLocation SPRITE_EMPTY =
            ResourceLocation.fromNamespaceAndPath(MultiversePowers.MODID, "hud/stamina/empty");
