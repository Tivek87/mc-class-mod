 ...
 * {@code nl.tivek.multiversepowers.mixin}). Only your own game fills it; on a server it stays empty. Kept here, apart
 * from the client's code, because the hook into every entity lives on both sides.
 */
