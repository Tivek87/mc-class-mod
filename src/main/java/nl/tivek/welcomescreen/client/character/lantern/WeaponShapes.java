...
final class WeaponShapes {
    ...
    static final ConstructPainter.Shape WHIP = ConstructPainter.Shape.of(whip());
    static final ConstructPainter.Shape GLOVE = ConstructPainter.Shape.of(glove());
    /** The left glove: the right one mirrored. */
    static final ConstructPainter.Shape LEFT_GLOVE = mirrored(GLOVE);
    static final ConstructPainter.Shape DAGGER = ConstructPainter.Shape.of(dagger());
    static final ConstructPainter.Shape BATTLEAXE = ConstructPainter.Shape.of(battleaxe());
    static final ConstructPainter.Shape WAR_HAMMER = ConstructPainter.Shape.of(warHammer());
    static final ConstructPainter.Shape HALBERD = ConstructPainter.Shape.of(halberd());
    static final ConstructPainter.Shape CHAINSAW = ConstructPainter.Shape.of(chainsaw());
    static final ConstructPainter.Shape REVOLVER = ConstructPainter.Shape.of(revolver());
    static final ConstructPainter.Shape SHOTGUN = ConstructPainter.Shape.of(shotgun());
    static final ConstructPainter.Shape SMG = ConstructPainter.Shape.of(smg());
    static final ConstructPainter.Shape ARM_CANNON = ConstructPainter.Shape.of(armCannon());
    static final ConstructPainter.Shape GRENADE_LAUNCHER = ConstructPainter.Shape.of(grenadeLauncher());
    static final ConstructPainter.Shape MINIGUN = ConstructPainter.Shape.of(minigun());
    static final ConstructPainter.Shape ROCKET_LAUNCHER = ConstructPainter.Shape.of(rocketLauncher());
    static final ConstructPainter.Shape FLAMETHROWER = ConstructPainter.Shape.of(flamethrower());
