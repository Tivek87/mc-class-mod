...
public final class AbilityKeys {
    public static final String CATEGORY = "key.categories." + WelcomeScreenMod.MODID;

    public static final KeyMapping SPELL_WHEEL = new KeyMapping(
            "key." + WelcomeScreenMod.MODID + ".spell_wheel",
    ...
    private static KeyMapping key(AbilitySlot slot, int defaultKey) {
        return new KeyMapping("key." + WelcomeScreenMod.MODID + ".ability_" + slot.getId(),
