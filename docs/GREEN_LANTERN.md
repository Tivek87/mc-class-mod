...
- **Slot 1: Sword & Shield.** De andere 15 slots hebben al hun naam en plaatje, maar doen nog wat lege handen doen: Energy Whip, Brawler Gauntlets / Boxing Gloves, Dual Energy Daggers, Battleaxe, Two-handed War Hammer, Spear / Halberd, Heavy Chainsaw, Dual Revolvers / Hand Cannons, Sawed-off Shotgun, Dual Micro-SMGs, Arm Cannon / Mega Blaster, Rotary Grenade Launcher, Minigun, Rocket Launcher / RPG en Plasma Flamethrower.
  ...
  - **Rechts vasthouden (schild):** je **blokt**: het schild komt recht voor je, net onder je blik, en houdt **85%** tegen van wat van voren komt zolang je vasthoudt (kost een beetje power zolang het op is). Met het zwaard kun je er gewoon achter vandaan slaan.
