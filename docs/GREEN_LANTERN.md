...
- **Vliegen:** Vooruit inhouden = vliegen in je kijkrichting. **Je komt snel op gang en gaat daarna steeds sneller hoe langer je doorvliegt:** je start op ongeveer **6,4 blokken per sec**, zit binnen **een halve sec** op een kruissnelheid van **8 blokken per sec** en wint daarna nog **ongeveer 6 seconden** snelheid, tot de top van **9,6 blokken per sec** (iets langzamer dan vliegen in creative), en nooit meer. Vooruit loslaten = uitglijden tot zweven, en de opgebouwde snelheid zakt langzaam weer weg (helemaal in 3 sec); tegen een muur duwen houdt hem vast. Springen = stijgen, bukken = zakken, links/rechts = opzij, achteruit = terugdrijven. Je neemt je snelheid mee in bochten. Begin-, kruis- en topsnelheid en beide opbouwtijden zijn instellingen.
...
- **Vliegend:** je duikt recht omlaag op 19,25 blokken per sec, twee keer je topsnelheid (je toetsen wachten tot je de grond raakt) en klapt waar je neerkomt. Niet tijdens het opstijgen.
...
- **Wie wordt geraakt:** alleen wat jou kwaad wil, en spelers waar spelers mogen vechten; nooit je eigen huisdieren, dorpelingen of dieren, nooit jijzelf.
