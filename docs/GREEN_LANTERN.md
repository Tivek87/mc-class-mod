...
- **Vliegen:** Vooruit inhouden = vliegen in je kijkrichting. **Je komt snel op gang en gaat daarna steeds sneller hoe langer je doorvliegt:** je start op ongeveer **12 blokken per sec**, zit binnen **een halve sec** op een kruissnelheid van **15 blokken per sec** en wint daarna nog **7 seconden** snelheid, tot de top van **18 blokken per sec** (sneller dan vliegen in creative), en nooit meer. Vooruit loslaten = uitglijden tot zweven, en de opgebouwde snelheid zakt langzaam weer weg (helemaal in 3 sec); tegen een muur duwen houdt hem vast. Springen = stijgen, bukken = zakken, links/rechts = opzij, achteruit = terugdrijven. Je neemt je snelheid mee in bochten. Begin-, kruis- en topsnelheid en beide opbouwtijden zijn instellingen.
...
- **Vliegend:** je duikt recht omlaag op 19,25 blokken per sec, sneller dan je topsnelheid (je toetsen wachten tot je de grond raakt) en klapt waar je neerkomt. Niet tijdens het opstijgen.
...
- **20 sec** lang vliegt hij door en vuurt hij onafgebroken:
  ...
  - **twee miniguns**, grote zesloopsgeweren die onder elke kant van de romp hangen, draaien soepel mee naar waar ze op vuren en blijven daar even op, en vuren om de beurt: samen **2 kogels per 0,14 sec**, lopen draaiend, mondingsvuur bij elk schot en slanke gloeiende lichtspoorkogels die omlaag schieten. Ze mikken op waar een lopend wezen is als de kogels aankomen. De kogels spreiden wijd, dus veel missen, maar het zijn er veel: **2,25 hart** per kogel die raakt. Missers vliegen door en brokkelen af.
...
- **Kosten:** 8 power. **Cooldown:** 30 sec. De schade, het bereik, hoeveel handen er per keer drukken komen (standaard 1) en hoe hard ze wezens wegslingeren zijn instellingen.
