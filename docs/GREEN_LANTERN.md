...
- **Veranderen in Green Lantern (de ring komt naar je toe):**
  ...
  - Alles samen ongeveer 8 seconden. Tot dat klaar is doet de ring niets anders.
...
- **Slot 16: Plasma Flamethrower.** Een zware vlammenwerper van hard licht: pistoolgreep in je ringhand, een loop met koelribben en een wijde mond met een waakvlam eronder, een ronde brandstoftank onder de voorkant met een klepwiel achterop en een slang naar de romp, en een voorgreep onder de tank voor je andere hand. Het wapen is solid; het vuur is plasma, groen met een witheet hart.
  ...
  - **Linksklik (vlammenzwaai):** je zwaait de mond van rechts naar links en een brede waaier vuur rolt over de hele boog naar voren, omkrullend; de volgende klik zwaait terug van links naar rechts, zodat snelle klikken in elkaar overlopen. Alles in de boog krijgt **2 harten** en wordt meegeduwd, tot 5,5 blokken. Kost 0,3 power.
